...
%      \LPIPSonly{} invents more than either adversarial arm.
...
an arm renders where the conditioning input asserts no structure is lowest for the \Lone{}
arm and highest for the \LPIPSonly{} arm, which invents more than either adversarial arm. The common factor is plausibility pressure, not the adversarial term. Matched directly, where it matches, the rasterised map itself localises better than every
