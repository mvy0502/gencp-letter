...
matches at worse positions. The mechanism is plausibility pressure, not the adversarial
term. The design rule: if you generate a reference image for a geometric consumer, do not
