...
The reading. Every arm except the L1-only one adds edges everywhere. The L1-only
arm adds them only where the input warrants it. That is conditional suppression,
