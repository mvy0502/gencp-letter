...
(b) ordering preserved in every cell but two, both far below threshold; the template
matcher widened the margin in all eight combinations &
Refuted by two registrations sharing no matcher, chip set or code \\
\bottomrule
\end{tabular}
\end{table*}
...
urban subset over 6,510 scored comparisons. The arm ordering is preserved in every
...
The reading. The candidate is refuted by two registrations that share no matcher,
no chip set and no scoring code. That is stronger evidence than either alone, and
