...
\begin{table*}[t]
\caption{Alternative explanations. Rows 1 and 3 are six-seed results; row 2 is a
single-seed (seed 42), chip-level checkpoint sweep, and its standard errors are across
chips. The corrected-georeferencing candidate is answered by design in the text
...
The answer is in the design and needs no measurement. No registered positional
