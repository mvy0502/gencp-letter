...
| `merkle2018exploring` | **VERIFIED (spelling caveat)** | Crossref 10.1109/JSTARS.2018.2803212: Nina Merkle, Stefan Auer, Rupert Muller, Peter Reinartz; IEEE JSTARS 11(6):1811–1820, 2018. Crossref gives 'Muller' without umlaut; IEEE Xplore's metadata endpoint could not be fetched, so the Crossref spelling is used as written and the umlaut question stands open |
...
Summary: 5 verified as written (one with an open umlaut question), 7 corrected: 2 wrong author lists (entries 39 and 40), 1 title punctuation, 3 with pages and DOI missing, 1 expanded from initials.
